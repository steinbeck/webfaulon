...
**Goal:** Displacement works on unsaturated/aromatic molecules (benzene, naphthalene) without crashing, with efficiency improvements for sparse graphs
**Depends on:** Phase 6
**Plans:** 2 plans

Plans:
- [x] 06.1-01-PLAN.md -- Remove SanitizeMol from set_bond(), add AROMATIC fallback, displacement retry logic
- [x] 06.1-02-PLAN.md -- Integration tests for unsaturated displacement and all 6 preset formulas
...
*Phase 6.1 retroactively documented: 2026-02-16*
